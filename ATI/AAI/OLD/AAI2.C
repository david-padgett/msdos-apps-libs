...
/*
   ...
   Procedure   : AAI_Select_File_Print_One_File_Name
...
void AAI_Select_File_Print_One_File_Name(LIST File_List, CARDINAL_16 Row, CARDINAL_32 Position, TEXT Text) {
...
/*
   ...
   Function    : AAI_Select_File_Print_File_Names
...
void AAI_Select_File_Print_File_Names(CARDINAL_32 Starting_File_Number, LIST File_List, TEXT Text) {
   ...
   for (i = 0; i < 8; i++) {
      ...
      AAI_Select_File_Print_One_File_Name(File_List, i, Starting_File_Number + i, Text);
...
int AAI_Select_File(CARDINAL_16 * Current_Row, CARDINAL_32 * Current_File_Number, CARDINAL_32 * Previous_File_Number, CARDINAL_32 * First_File_Number, AAI_COLORS * Colors, TEXT Text, CARDINAL_16 * Key, LIST * File_List, char * File_Name) {
   ...
   if (result == EZERO) {
      ...
      if (*(Previous_File_Number) != *(Current_File_Number) || display_light_bar_flag) {
         ...
         if (refresh_screen_flag) {
            ...
            AAI_Select_File_Print_File_Names(*(First_File_Number), *(File_List), Text);

         }
         else {

            TEXT_Set_Text_Color(Colors->Primary_Color, Text);
            AAI_Select_File_Print_One_File_Name(*(File_List), *(Current_Row), *(Previous_File_Number), Text);
         ...
         AAI_Select_File_Print_One_File_Name(*(File_List), *(Current_Row), *(Current_File_Number), Text);
...
int AAI_File_Load(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_FILE_LOAD_PARAMETERS * parameters;
   ...
   */
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         AAI_Set_Help_Screen(parameters->Parameters_List, AAI_Help_Index_Key_List[AAI_HELP_LODFM]);
         ...
         if (result == EZERO) {
            ...
            result = AAI_Select_File(&(parameters->Current_Row), &(parameters->Current_File_Number), &(parameters->Previous_File_Number), &(parameters->First_File_Number), &(parameters->Colors), parameters->Text, Key, &(parameters->File_List), parameters->File_Name);
            ...
            if (parameters->File_Name[0] != '\0') {
               ...
               exit_flag = TRUE;
               result = AAI_Load_Edit_Parameters(parameters->File_Name, parameters->Edit_Parameters);
            ...
            if (exit_flag) {
               ...
               AAI_Halt_Process(parameters->Parameters_List, AAI_FILE_LOAD_PROCESS);
               AAI_Activate_Process(parameters->Parameters_List, AAI_MAIN_MENU_PROCESS);
               *(Key) = 0;
...
int AAI_File_New(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_FILE_NEW_PARAMETERS * parameters;
   int                       result;
   ...
   */
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         parameters = *(Process_Parameters);
         AAI_Set_Help_Screen(parameters->Parameters_List, AAI_Help_Index_Key_List[AAI_HELP_NEWFM]);
         ...
         if (parameters->Process_In_Progress_Flag) {
            ...
            if ((int) parameters->Clear_Memory_Flag != 255) {
               ...
               if (parameters->Clear_Memory_Flag) {
                  ...
                  AAI_Clear_Edit_Parameters(parameters->Edit_Parameters);
                  parameters->Load_Parameters->File_Name[0] = '\0';

               }

               parameters->Process_In_Progress_Flag = FALSE;
               AAI_Halt_Process(parameters->Parameters_List, AAI_FILE_NEW_PROCESS);
               AAI_Activate_Process(parameters->Parameters_List, AAI_MAIN_MENU_PROCESS);
            }
            ...
            AAI_Activate_Process(parameters->Parameters_List, AAI_YES_NO_MENU_PROCESS);

            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Starting_Row = 9;
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Starting_Column = 21;
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Display_Message = "Clear Current Times, Are You Sure?";
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Option = 1;
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Invoking_Process = AAI_MAIN_MENU_PROCESS;
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Yes_Selected_Flag = &(((AAI_FILE_NEW_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_FILE_NEW_PROCESS].Process_Parameters)->Clear_Memory_Flag);
...
int AAI_File_Save(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_FILE_SAVE_PARAMETERS * parameters;
   BOOLEAN                    exit_flag = FALSE;
   char                       str[9];
   int                        result;
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         if (parameters->Load_Parameters->File_Name[7] != '\xff') {
            ...
            AAI_Set_Help_Screen(parameters->Parameters_List, AAI_Help_Index_Key_List[AAI_HELP_SAVFM]);

         }

         if (parameters->Load_Parameters->File_Name[0] != '\0') {

            result = AAI_Save_Edit_Parameters(parameters->Load_Parameters->File_Name, parameters->Edit_Parameters);
            exit_flag = TRUE;
            ...
            if (parameters->Port != NULL) {
               ...
               if ((result = PORT_Constructor(parameters->Starting_Row, parameters->Starting_Column, parameters->Height, parameters->Width, PORT_SINGLE_LINE_BORDER, parameters->Colors.Primary_Color, parameters->Colors.Primary_Color, &(parameters->Port))) == PORT_NOERR) {
                  ...
                  AAI_Input(&(parameters->File_Name), Key);
         ...
         if (exit_flag) {
            ...
            AAI_Halt_Process(parameters->Parameters_List, AAI_FILE_SAVE_PROCESS);
            AAI_Activate_Process(parameters->Parameters_List, AAI_MAIN_MENU_PROCESS);
...
int AAI_File_Save_As(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_FILE_SAVE_AS_PARAMETERS * parameters;
   int                           result;
   ...
   */
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         parameters = *(Process_Parameters);
         AAI_Set_Help_Screen(parameters->Parameters_List, AAI_Help_Index_Key_List[AAI_HELP_SVAFM]);
         parameters->Load_Parameters->File_Name[0] = '\0';
         parameters->Load_Parameters->File_Name[7] = '\xff';
         AAI_Halt_Process(parameters->Parameters_List, AAI_FILE_SAVE_AS_PROCESS);
...
int AAI_File_Delete(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_FILE_DELETE_PARAMETERS * parameters;
   BOOLEAN                      exit_flag = FALSE;
   ...
   */
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         parameters = *(Process_Parameters);
         AAI_Set_Help_Screen(parameters->Parameters_List, AAI_Help_Index_Key_List[AAI_HELP_DELFM]);
            ...
            if (parameters->File_Name[0] == '\0') {
               ...
               if (parameters->Process_In_Progress_Flag) {
                  ...
                  if ((int) parameters->Delete_File_Flag != -1) {
                     ...
                     parameters->Process_In_Progress_Flag = FALSE;
                     AAI_Halt_Process(parameters->Parameters_List, AAI_FILE_DELETE_PROCESS);
                     AAI_Activate_Process(parameters->Parameters_List, AAI_MAIN_MENU_PROCESS);
                     exit_flag = TRUE;
                  ...
                  ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Starting_Row = 9;
                  ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Starting_Column = 21;
                  ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Display_Message = "Delete File, Are You Sure?";
                  ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Option = 1;
                  ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Invoking_Process = AAI_FILE_DELETE_PROCESS;
                  ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Yes_Selected_Flag = &(((AAI_FILE_DELETE_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_FILE_DELETE_PROCESS].Process_Parameters)->Delete_File_Flag);
...
int AAI_File_Rename(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_FILE_RENAME_PARAMETERS * parameters;
   BOOLEAN                      exit_flag = FALSE;
   ...
   */
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         parameters = *(Process_Parameters);
         AAI_Set_Help_Screen(parameters->Parameters_List, AAI_Help_Index_Key_List[AAI_HELP_RENFM]);
         ...
         if (result == EZERO) {
            ...
            if (parameters->Current_File_Name[0] == '\0') {
               ...
               result = AAI_Select_File(&(parameters->Current_Row), &(parameters->Current_File_Number), &(parameters->Previous_File_Number), &(parameters->First_File_Number), &(parameters->Colors), parameters->Text, Key, &(parameters->File_List), parameters->Current_File_Name);
               ...
               AAI_Input(&(parameters->New_File_Name), Key);
            ...
            if (exit_flag) {
               ...
               PORT_Destructor(&(parameters->Port));
               AAI_Halt_Process(parameters->Parameters_List, AAI_FILE_RENAME_PROCESS);
               AAI_Activate_Process(parameters->Parameters_List, AAI_MAIN_MENU_PROCESS);
               *(Key) = 0;
...
int AAI_File_Quit(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_FILE_QUIT_PARAMETERS * parameters;
   int                        result;
   ...
   */
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         parameters = *(Process_Parameters);
         AAI_Set_Help_Screen(parameters->Parameters_List, AAI_Help_Index_Key_List[AAI_HELP_QUIFM]);

         AAI_Halt_Process(parameters->Parameters_List, AAI_MAIN_MENU_PROCESS);
         AAI_Activate_Process(parameters->Parameters_List, AAI_YES_NO_MENU_PROCESS);

         ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Starting_Row = 9;
         ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Starting_Column = 25;
         ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Display_Message = "Exit Program, Are You Sure?";
         ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Option = 1;
         ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Invoking_Process = AAI_MAIN_MENU_PROCESS;
         ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Yes_Selected_Flag = &(((AAI_MAIN_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_MAIN_MENU_PROCESS].Process_Parameters)->Exit_Flag);

         AAI_Halt_Process(parameters->Parameters_List, AAI_FILE_QUIT_PROCESS);
...
/*
   ...
   Procedure   : AAI_Edit_Print_Labels
   Description :
...
void AAI_Edit_Print_Labels(AAI_EDIT_EDIT_PARAMETERS * Process_Parameters, CARDINAL_16 * Key) {
   ...
   for (i = 0; i < 8; i++) {
      ...
      for (j = 0; j < 5; j++) {
         ...
         AAI_Input(&(Process_Parameters->Advance_Time[k]), Key);
         ...
         AAI_Input(&(Process_Parameters->Retract_Time[k]), Key);
...
/*
   ...
   Procedure   : AAI_Edit_Update_Process_Parameters
...
void AAI_Edit_Update_Process_Parameters(BOOLEAN Update_Top_Row_Starting_Number_Flag, int Top_Row_Starting_Number_Increment_Value, AAI_EDIT_EDIT_PARAMETERS * Process_Parameters) {
   ...
   if (Process_Parameters->Current_Field_Descriptor->Type == INTEGER_16_TYPE) {
      ...
      AAI_Input(Process_Parameters->Current_Field_Descriptor, NULL);

   }

   if (Top_Row_Starting_Number_Increment_Value >= 0) {

      Process_Parameters->Field = (Process_Parameters->Field >= AAI_TOTAL_EDIT_FIELDS) ? AAI_TOTAL_EDIT_FIELDS : Process_Parameters->Field + 1;
...
/*
   ...
   Procedure   : AAI_Edit_Set_Refresh_Flag
   Description :
   Inputs      : Process_Parameters
   Updates     : Nothing.
   Outputs     : Nothing.
...
void AAI_Edit_Set_Refresh_Flag(AAI_EDIT_EDIT_PARAMETERS * Process_Parameters) {
...
/*
   ...
   Procedure   : AAI_Edit_Set_First_Pass_Flag
   Description :
   Inputs      : Process_Parameters
   Updates     : Nothing.
   Outputs     : Nothing.
...
void AAI_Edit_Set_First_Pass_Flag(AAI_EDIT_EDIT_PARAMETERS * Process_Parameters) {
...
/*
   ...
   Procedure   : AAI_Edit_Initialize_Current_Offset
   Description :
   Inputs      : Process_Parameters
   Updates     : Nothing.
   Outputs     : Nothing.
...
void AAI_Edit_Initialize_Current_Offset(AAI_EDIT_EDIT_PARAMETERS * Process_Parameters) {
...
/*
   ...
   Procedure   : AAI_Edit_Special_Processing
   Description :
   Inputs      : Process_Parameters                  =
   Updates     : Nothing.
...
void AAI_Edit_Special_Processing(AAI_EDIT_EDIT_PARAMETERS * Process_Parameters, BOOLEAN * Update_Top_Row_Starting_Number_Flag, BOOLEAN * Timing_Values_Altered_Flag) {

   INTEGER_16 displacement_value, previous_value;
   int        i;

   if (Process_Parameters->Field >= AAI_TOTAL_UNIQUE_EDIT_FIELDS) {
         ...
         if (Process_Parameters->Current_Field_Descriptor->Value[0] == '+' || Process_Parameters->Current_Field_Descriptor->Value[0] == '-') {
            ...
            if (previous_value == 0) {
               ...
               *(Timing_Values_Altered_Flag) = TRUE;
               ...
               for (i = (Process_Parameters->Field - AAI_TOTAL_UNIQUE_EDIT_FIELDS) / 2; i < (AAI_TOTAL_EDIT_FIELDS - AAI_TOTAL_UNIQUE_EDIT_FIELDS + 1) / 2; i++) {
	 ...
	 */
         ...
         if (atoi(Process_Parameters->Advance_Time[(Process_Parameters->Field - AAI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Value) != 0 && atoi(Process_Parameters->Advance_Time[(Process_Parameters->Field - AAI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Value) >= atoi(Process_Parameters->Retract_Time[(Process_Parameters->Field - AAI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Value)) {

            Process_Parameters->Retract_Time[(Process_Parameters->Field - AAI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Integer_Value = atoi(Process_Parameters->Advance_Time[(Process_Parameters->Field - AAI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Value) + 1;
            sprintf(Process_Parameters->Retract_Time[(Process_Parameters->Field - AAI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Value, "%*d", Process_Parameters->Retract_Time[(Process_Parameters->Field - AAI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Display_Length, Process_Parameters->Retract_Time[(Process_Parameters->Field - AAI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Integer_Value);
            Process_Parameters->Retract_Time[(Process_Parameters->Field - AAI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Refresh_Flag = TRUE;
            AAI_Input(&(Process_Parameters->Retract_Time[(Process_Parameters->Field - AAI_TOTAL_UNIQUE_EDIT_FIELDS) / 2]), NULL);
	    ...
	    */
            ...
            if (Process_Parameters->Retract_Time[(Process_Parameters->Field - AAI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Integer_Value > Process_Parameters->Total_Cycle_Time.Integer_Value) {

               sprintf(Process_Parameters->Total_Cycle_Time.Value, "%*d", Process_Parameters->Total_Cycle_Time.Display_Length, Process_Parameters->Retract_Time[(Process_Parameters->Field - AAI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Integer_Value);
               Process_Parameters->Total_Cycle_Time.Integer_Value = atoi(Process_Parameters->Total_Cycle_Time.Value);
               Process_Parameters->Total_Cycle_Time.Refresh_Flag = TRUE;
               AAI_Input(&(Process_Parameters->Total_Cycle_Time), NULL);
         ...
         if (Process_Parameters->Field % 2 == 0 && atoi(Process_Parameters->Current_Field_Descriptor->Value) > atoi(Process_Parameters->Last_Bin_Sensor.Value) && atoi(Process_Parameters->Current_Field_Descriptor->Value) <= Process_Parameters->Last_Bin_Sensor.Maximum_Editable_Value && atoi(Process_Parameters->Current_Field_Descriptor->Value) >= Process_Parameters->Last_Bin_Sensor.Minimum_Value) {
            ...
            Process_Parameters->Last_Bin_Sensor.Refresh_Flag = TRUE;
            AAI_Input(&(Process_Parameters->Last_Bin_Sensor), NULL);
...
int AAI_Edit(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_EDIT_EDIT_PARAMETERS * parameters;
   AAI_PROCESS_TYPES          new_process;
   ...
   */
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         parameters = *(Process_Parameters);
         AAI_Set_Help_Screen(parameters->Parameters_List, AAI_Help_Index_Key_List[AAI_HELP_EDTEM]);
         ...
         if (parameters->Port != NULL) {
            ...
            if ((result = PORT_Constructor(parameters->Starting_Row, parameters->Starting_Column, parameters->Height, parameters->Width, PORT_SINGLE_LINE_BORDER, parameters->Colors.Primary_Color, parameters->Colors.Primary_Color, &(parameters->Port))) == PORT_NOERR) {
               ...
               AAI_Edit_Print_Labels(parameters, Key);

               AAI_Input(&(parameters->Part_Number), Key);
               AAI_Input(&(parameters->Valve_Pack_Number), Key);
               AAI_Input(&(parameters->Multiple_Part_Number), Key);
               AAI_Input(&(parameters->Last_Bin_Sensor), Key);
               AAI_Input(&(parameters->Total_Cycle_Time), Key);
         ...
         if (result == EZERO) {
            ...
            switch (*(Key)) {
               ...
               case KB_GRAY_RIGHT :
                  ...
                  AAI_Edit_Special_Processing(parameters, &(update_top_row_starting_number_flag), &(timing_values_altered_flag));

                  if ((parameters->Field - ((parameters->Top_Row_Starting_Number - 1) * 2)) >= (80 + AAI_TOTAL_UNIQUE_EDIT_FIELDS - 1) && parameters->Top_Row_Starting_Number < 41) {
                  ...
                  AAI_Edit_Update_Process_Parameters(update_top_row_starting_number_flag | timing_values_altered_flag, (timing_values_altered_flag) ? 0 : 5, parameters);
                  break;
               ...
               case KB_GRAY_LEFT :
                  ...
                  AAI_Edit_Special_Processing(parameters, &(update_top_row_starting_number_flag), &(timing_values_altered_flag));
                  update_top_row_starting_number_flag = (parameters->Top_Row_Starting_Number > 1 && parameters->Field - ((parameters->Top_Row_Starting_Number - 1) * 2) <= AAI_TOTAL_UNIQUE_EDIT_FIELDS - 1);
                  AAI_Edit_Update_Process_Parameters(update_top_row_starting_number_flag, -5, parameters);
                  direction = -1;
                  break;
               ...
               case KB_GRAY_DOWN :
                  ...
                  AAI_Edit_Special_Processing(parameters, &(update_top_row_starting_number_flag), &(timing_values_altered_flag));
                  AAI_Edit_Update_Process_Parameters(FALSE, 0, parameters);
                  parameters->Field--;

                  if (parameters->Field < AAI_TOTAL_UNIQUE_EDIT_FIELDS) {

                     parameters->Field = AAI_TOTAL_UNIQUE_EDIT_FIELDS;

                  }
                  else {

                     if (parameters->Field <= AAI_TOTAL_EDIT_FIELDS - 10) {
               ...
               case KB_GRAY_UP :
                  ...
                  if (parameters->Field != AAI_TOTAL_EDIT_FIELDS) {

                     parameters->Field--;

                  }

                  if (parameters->Field >= AAI_TOTAL_UNIQUE_EDIT_FIELDS && parameters->Field < AAI_TOTAL_UNIQUE_EDIT_FIELDS + 10) {
                     ...
                     if (parameters->Field >= AAI_TOTAL_UNIQUE_EDIT_FIELDS + 10) {

                        parameters->Field -= 10;

                        if (parameters->Field <= ((parameters->Top_Row_Starting_Number - 1) * 2) + AAI_TOTAL_UNIQUE_EDIT_FIELDS - 1) {
               ...
               case KB_CTRL_GRAY_END :
                  ...
                  AAI_Edit_Special_Processing(parameters, &(update_top_row_starting_number_flag), &(timing_values_altered_flag));
                  AAI_Edit_Update_Process_Parameters(FALSE, 0, parameters);
                  parameters->Field = AAI_TOTAL_EDIT_FIELDS;
               ...
               case KB_ESC :
                  ...
                  new_process = AAI_MAIN_MENU_PROCESS;
                  exit_flag = TRUE;
                  break;

               case KB_F5 :

                  new_process = AAI_EDIT_MARK_PROCESS;
                  AAI_Activate_Process(parameters->Parameters_List, new_process);
                  break;

               case KB_F6 :

                  new_process = AAI_EDIT_CLEAR_PROCESS;
                  AAI_Activate_Process(parameters->Parameters_List, new_process);
                  break;

            }

            if (parameters->Parameters_List->Version == AAI_PLANT_VERSION && parameters->Field == 2 && parameters->Valve_Pack_Number.Integer_Value != 0) {
            ...
            *(Key) = (refresh_flag) ? 0 : *(Key);
            ...
            switch (input_field) {
               ...
               default :
                  ...
                  parameters->Current_Field_Descriptor = ((input_field - AAI_TOTAL_UNIQUE_EDIT_FIELDS) % 2 == 0) ? &(parameters->Advance_Time[(input_field - AAI_TOTAL_UNIQUE_EDIT_FIELDS) / 2]) : &(parameters->Retract_Time[(input_field - AAI_TOTAL_UNIQUE_EDIT_FIELDS) / 2]);

            }

            if (refresh_flag) {

               AAI_Edit_Set_Refresh_Flag(parameters);
               AAI_Edit_Initialize_Current_Offset(parameters);
            ...
            if (new_field_flag) {
               ...
               AAI_Edit_Set_First_Pass_Flag(parameters);
               parameters->Current_Field_Descriptor->First_Pass_Flag = TRUE;

            }

            AAI_Input(parameters->Current_Field_Descriptor, Key);

            if (exit_flag) {

               PORT_Destructor(&(parameters->Port));
               AAI_Halt_Process(parameters->Parameters_List, AAI_EDIT_EDIT_PROCESS);
               AAI_Activate_Process(parameters->Parameters_List, new_process);
...
int AAI_Mark(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_EDIT_MARK_PARAMETERS * parameters;
   int                        result;
   ...
   */
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         parameters = *(Process_Parameters);
         AAI_Set_Help_Screen(parameters->Parameters_List, AAI_Help_Index_Key_List[AAI_HELP_MAREM]);
         ...
         AAI_Halt_Process(parameters->Parameters_List, AAI_EDIT_MARK_PROCESS);
         AAI_Activate_Process(parameters->Parameters_List, AAI_EDIT_EDIT_PROCESS);
   ...
   */
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         parameters = *(Process_Parameters);
         AAI_Set_Help_Screen(parameters->Parameters_List, AAI_Help_Index_Key_List[AAI_HELP_CLEEM]);
         parameters->Edit_Parameters->Current_Field_Descriptor->Marked_Flag = FALSE;
         parameters->Edit_Parameters->Current_Field_Descriptor->Refresh_Flag = TRUE;
         AAI_Halt_Process(parameters->Parameters_List, AAI_EDIT_CLEAR_PROCESS);
         AAI_Activate_Process(parameters->Parameters_List, AAI_EDIT_EDIT_PROCESS);
...
/*
   ...
   Function    : AAI_Reports_Data_Dump
...
int AAI_Reports_Data_Dump(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_REPORTS_DATA_DUMP_PARAMETERS * parameters;
   FILE *                             report_file;
   time_t                             timer;
   ...
   */
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         parameters = *(Process_Parameters);
         AAI_Set_Help_Screen(parameters->Parameters_List, AAI_Help_Index_Key_List[AAI_HELP_DDPRM]);
         ...
         if (parameters->Process_In_Progress_Flag) {
            ...
            if ((int) parameters->Print_Report_Flag != -1) {
               ...
               if (parameters->Stop_Process_Flag) {
                  ...
                  parameters->Process_In_Progress_Flag = FALSE;
                  AAI_Halt_Process(parameters->Parameters_List, AAI_REPORTS_DATA_DUMP_PROCESS);
                  AAI_Activate_Process(parameters->Parameters_List, AAI_MAIN_MENU_PROCESS);
            ...
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Starting_Row = 9;
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Starting_Column = 23;
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Display_Message = "Is The Printer On-Line And Ready?";
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Option = 1;
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Invoking_Process = AAI_REPORTS_DATA_DUMP_PROCESS;
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Yes_Selected_Flag = &(((AAI_REPORTS_DATA_DUMP_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_REPORTS_DATA_DUMP_PROCESS].Process_Parameters)->Print_Report_Flag);
...
/*
   ...
   Function    : AAI_Reports_Available_Configurations
...
int AAI_Reports_Available_Configurations(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_REPORTS_AVAIL_CFG_PARAMETERS * parameters;
   FILE *                             report_file;
   ...
   */
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         parameters = *(Process_Parameters);
         AAI_Set_Help_Screen(parameters->Parameters_List, AAI_Help_Index_Key_List[AAI_HELP_ACGRM]);
         ...
         if (parameters->Process_In_Progress_Flag) {
            ...
            if ((int) parameters->Print_Report_Flag != -1) {
               ...
               if (parameters->Stop_Process_Flag) {
                  ...
                  parameters->Stop_Process_Flag = FALSE;
                  parameters->Process_In_Progress_Flag = FALSE;
                  AAI_Halt_Process(parameters->Parameters_List, AAI_REPORTS_AVAIL_CFG_PROCESS);
                  AAI_Activate_Process(parameters->Parameters_List, AAI_MAIN_MENU_PROCESS);
            ...
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Display_Message = "Is The Printer On-Line And Ready?";
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Option = 1;
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Invoking_Process = AAI_REPORTS_AVAIL_CFG_PROCESS;
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Yes_Selected_Flag = &(((AAI_REPORTS_AVAIL_CFG_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_REPORTS_AVAIL_CFG_PROCESS].Process_Parameters)->Print_Report_Flag);
...
/*
   ...
   Function    : AAI_Initialize_Comm_Port
   Description : Initializes the communcations port for use.
...
int AAI_Initialize_Comm_Port(int Port_No, int IQ_Size, int OQ_Size, int Int_Level, int Port_Ads, char * Pbuffer) {
...
/*
   ...
   Procedure   : AAI_Send_Calculate_Valve_Packs
   Description :
   Inputs      :
   Updates     :
   Outputs     :
...
void AAI_Send_Calculate_Valve_Packs(AAI_COMMUNICAAIONS_SEND_PARAMETERS * Process_Parameters) {
...
/*
   ...
   Procedure   : AAI_Send_Construct_Send_String
   Description :
   Inputs      :
   Updates     :
   Outputs     :
...
void AAI_Send_Construct_Send_String(AAI_COMMUNICAAIONS_SEND_PARAMETERS * Process_Parameters) {
      ...
      default :
         ...
         switch (Process_Parameters->Parameter_Number) {
            ...
            default :
               ...
               i = (Process_Parameters->Parameter_Number - AAI_TOTAL_UNIQUE_EDIT_FIELDS - 1) / 2;
...
/*
   ...
   Procedure   : AAI_Send_Print_Error_Code
   Description :
   Inputs      : Text
                 Parameter_Number
                 Error_Code
...
void AAI_Send_Print_Error_Code(TEXT Text, int Parameter_Number, int Error_Code, char * Error_Message) {
...
int AAI_Send(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_COMMUNICAAIONS_SEND_PARAMETERS * parameters;
   ...
   */
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         parameters = *(Process_Parameters);
         AAI_Set_Help_Screen(parameters->Parameters_List, AAI_Help_Index_Key_List[AAI_HELP_SNDCM]);
         ...
         if (parameters->Port == NULL) {
            ...
            if ((result = PORT_Constructor(parameters->Starting_Row, parameters->Starting_Column, parameters->Height, parameters->Width, PORT_SINGLE_LINE_BORDER, parameters->Colors.Primary_Color, parameters->Colors.Primary_Color, &(parameters->Port))) == PORT_NOERR) {
               ...
               AAI_Input(&(parameters->Unit_Number), Key);
               parameters->Save_Timing_Values.Refresh_Flag = TRUE;
               AAI_Input(&(parameters->Save_Timing_Values), Key);
               parameters->Send_Raw_Data_File = fopen("AAI.SND", "wt");
               AAI_Send_Calculate_Valve_Packs(parameters);
            ...
            if (parameters->Get_Parameters_Flag) {
               ...
               if (parameters->First_Pass_Flag) {
                  ...
                  result = AAI_Initialize_Comm_Port(parameters->Port_No, parameters->IQ_Size, parameters->OQ_Size, parameters->Int_Level, parameters->Port_Ads, parameters->Pbuffer);
                  parameters->First_Pass_Flag = FALSE;
                  AAI_Send_Construct_Send_String(parameters);
               ...
               if (*(Key) == KB_ESC) {
                  ...
                  *(Key) = 0;
                  ...
                  AAI_Send_Print_Error_Code(parameters->Text, parameters->Parameter_Number, result, "");
                  AAI_Send_Construct_Send_String(parameters);
         ...
         if (parameters->Exit_Flag) {
            ...
            if (poq_size == 0 || parameters->Abort_Flag) {
               ...
               AAI_Halt_Process(parameters->Parameters_List, AAI_COMMUNICAAIONS_SEND_PROCESS);
               AAI_Activate_Process(parameters->Parameters_List, AAI_MAIN_MENU_PROCESS);
...
/*
   ...
   Function    : AAI_Receive_Decode_String
   Description :
   Inputs      : Process_Parameters
   Updates     : Nothing.
   Outputs     : Nothing.
...
int AAI_Receive_Decode_String(AAI_COMMUNICAAIONS_RECEIVE_PARAMETERS * Process_Parameters) {
...
int AAI_Receive(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_COMMUNICAAIONS_RECEIVE_PARAMETERS * parameters;
   ...
   */
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         parameters = *(Process_Parameters);
         AAI_Set_Help_Screen(parameters->Parameters_List, AAI_Help_Index_Key_List[AAI_HELP_RECCM]);
         ...
         if (parameters->Port == NULL) {
            ...
            if (parameters->First_Pass_Flag) {
               ...
               parameters->Receive_Raw_Data_File = fopen("AAI.REC", "wt");
               ...
               if (*(Key) == KB_ESC) {
                  ...
                  *(Key) = 0;
                        ...
                        if (ch != '\r' && ch != '\n' && parameters->Receive_String_Offset < sizeof(parameters->Receive_String)) {
                           ...
                           if (ch == '\n') {
                              ...
                              if (++parameters->Lines_Received > 6) {
                                 ...
                                 result = AAI_Receive_Decode_String(parameters);
                  ...
                  AAI_Send_Print_Error_Code(parameters->Text, parameters->Parameter_Number, result, parameters->Error_Message);
               ...
               if (parameters->Exit_Flag) {
                  ...
                  parameters->Parameter_Number = 0;
                  result = close_a1(parameters->Port_No);
                  AAI_Halt_Process(parameters->Parameters_List, AAI_COMMUNICAAIONS_RECEIVE_PROCESS);
                  AAI_Activate_Process(parameters->Parameters_List, AAI_MAIN_MENU_PROCESS);
                  PORT_Destructor(&(parameters->Port));
...
int AAI_Terminal(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_COMMUNICAAIONS_TERMINAL_PARAMETERS * parameters;
   CARDINAL_16                              x, y;
   BOOLEAN                                  exit_flag = FALSE;
   static char                              str[81];
   ...
   */
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         parameters = *(Process_Parameters);
         AAI_Set_Help_Screen(parameters->Parameters_List, AAI_Help_Index_Key_List[AAI_HELP_TERCM]);
         ...
         if (parameters->Port == NULL) {
            ...
            if ((result = PORT_Constructor(parameters->Starting_Row, parameters->Starting_Column, parameters->Height, parameters->Width, PORT_NO_BORDER, parameters->Colors.Primary_Color, parameters->Colors.Primary_Color, &(parameters->Port))) == PORT_NOERR) {
               ...
               AAI_Halt_Process(parameters->Parameters_List, AAI_DISPLAY_TIME_PROCESS);
               window(1, 1, 80, 25);
            ...
            if (parameters->First_Pass_Flag) {
               ...
               if (parameters->Exit_Flag) {
                  ...
                  CURSOR_Off();
                  PORT_Destructor(&(parameters->Port));
                  AAI_Halt_Process(parameters->Parameters_List, AAI_COMMUNICAAIONS_TERMINAL_PROCESS);
                  AAI_Activate_Process(parameters->Parameters_List, AAI_DISPLAY_TIME_PROCESS);
                  AAI_Activate_Process(parameters->Parameters_List, AAI_MAIN_MENU_PROCESS);
                  parameters->First_Pass_Flag = TRUE;
                  parameters->Exit_Flag = FALSE;
                  result = close_a1(parameters->Port_No);
...
int AAI_Help_Index(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_HELP_INDEX_PARAMETERS * parameters;
   AAI_HELP_INDEX_LIST *       help_index;
   AAI_HELP_INDEX_LIST         help_index_node;
   AAI_HELP_TEXT_LIST *        help_text;
   AAI_HELP_TEXT_LIST          help_text_node;
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         if (parameters->Help_File == NULL && !parameters->Help_Loaded_Flag) {
            ...
            parameters->Help_Available_Flag = ((parameters->Help_File = fopen("AAI.HLP", "rt")) != NULL);
            ...
            if (!parameters->Help_Loaded_Flag) {
               ...
               if (fgets(str, sizeof(str) - 1, parameters->Help_File) == NULL) {
                  ...
                  AAI_Halt_Process(parameters->Parameters_List, AAI_HELP_INDEX_PROCESS);
               ...
               AAI_Set_Help_Screen(parameters->Parameters_List, AAI_Help_Index_Key_List[AAI_HELP_INDHM]);
               ...
               if (result == EZERO) {
                  ...
                  switch (*(Key)) {
                     ...
                     case KB_ENTER :
                        ...
                        AAI_Set_Help_Screen(parameters->Parameters_List, help_index->Index_Key);
...
int AAI_Help_About(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_HELP_ABOUT_PARAMETERS * parameters;
   int                         result;
   ...
   */
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         parameters = *(Process_Parameters);
         AAI_Set_Help_Screen(parameters->Parameters_List, AAI_Help_Index_Key_List[AAI_HELP_ABOHM]);
...
*/
         ...
         if (result == EZERO) {
            ...
            if (*(Key) != 0 && *(Key) != KB_F1) {
               ...
               *(Key) = 0;
               AAI_Halt_Process(parameters->Parameters_List, AAI_HELP_ABOUT_PROCESS);
               AAI_Activate_Process(parameters->Parameters_List, AAI_MAIN_MENU_PROCESS);
...
int AAI_Help_Print(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_HELP_PRINT_PARAMETERS * parameters;
   AAI_HELP_TEXT_LIST *        help_text;
   char                        str[256];
   int                         result;
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         if (!parameters->Process_In_Progress_Flag) {
            ...
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Display_Message = "Is The Printer On-Line And Ready?";
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Option = 1;
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Invoking_Process = AAI_HELP_PRINT_PROCESS;
            ((AAI_YES_NO_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_YES_NO_MENU_PROCESS].Process_Parameters)->Yes_Selected_Flag = &(((AAI_HELP_PRINT_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[AAI_HELP_PRINT_PROCESS].Process_Parameters)->Print_Report_Flag);
            parameters->Process_In_Progress_Flag = TRUE;
            result = EZERO;
         ...
         if (parameters->Exit_Flag) {
            ...
            parameters->Exit_Flag = FALSE;
            AAI_Halt_Process(parameters->Parameters_List, AAI_HELP_PRINT_PROCESS);
            AAI_Activate_Process(parameters->Parameters_List, AAI_MAIN_MENU_PROCESS);
...
int AAI_Help_Topic(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   AAI_HELP_TOPIC_PARAMETERS * parameters;
   AAI_HELP_TEXT_LIST *        help_text;
   CARDINAL_32                 total_lines;
   char                        str[256];
   int                         i, result;
   ...
   if ((result = AAI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
	 ...
	 */
         ...
         if (parameters->Exit_Flag) {
            ...
            parameters->Exit_Flag = FALSE;
            PORT_Destructor(&(parameters->Port));
				AAI_Halt_Process(parameters->Parameters_List, AAI_HELP_TOPIC_PROCESS);

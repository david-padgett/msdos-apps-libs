/*
   ...
   Modified    : 08/18/92 DWP Created.
                 02/13/93 DWP Added Display_Length field to variables of type BMI_INPUT_DESCRIPTOR.  Created Winchester Version.
   Notes       :
...
/*
   ...
   Returns     : The value of the last error that occurred.  A value of zero indicates that no errors occurred.
   Modified    : 08/18/92 DWP Initial coding.
                 02/13/93 DWP Added Display_Length field to variables of type BMI_INPUT_DESCRIPTOR.
   Notes       :
...
int BMI_Initialize(BMI_PARAMETERS_LIST * Parameters_List) {
   ...
   if (BMI_Load_Configuration(BMI_CONFIG_FILE_NAME, &(Parameters_List->Default_Parameters)) != EZERO || (Parameters_List->Display_Type != Parameters_List->Default_Parameters.Display_Type) || (Parameters_List->Port_No != Parameters_List->Default_Parameters
.Port_No)) {
         ...
         if (result == EZERO) {
            ...
            switch (process_number) {
               ...
               case BMI_EDIT_EDIT_PROCESS :
                  ...
                  edit_edit_parameters->Valve_Pack_Number.Edit_Length = (Parameters_List->Version == BMI_PLANT_VERSION) ? 4 : 5;
                  ...
                  edit_edit_parameters->Valve_Pack_Number.Maximum_Editable_Value = (Parameters_List->Version == BMI_PLANT_VERSION) ? 9999 : 16383;
...
int main(int argc, char * argv[]) {
   ...
   if (_osmajor < 3 || (_osmajor == 3 && _osminor < 3)) {
      ...
      */
      ...
      parameters_list.Version = (stricmp(DIR_Retrieve_File_Name(argv[0], sizeof(program_file_name), program_file_name), "BMIWIN") == 0) ? BMI_WINCHESTER_VERSION : BMI_PLANT_VERSION;

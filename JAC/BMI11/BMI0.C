...
char BMI_Function_Key_Menu_Text[] =
...
char BMI_Edit_Menu_Text[] =

   MENU_SECONDARY_COLOR "E" MENU_PRIMARY_COLOR "dit..."  MENU_VERTICAL_TAB "\x1" MENU_END_OF_OPTION
...
char BMI_Report_Menu_Text[] =

   MENU_SECONDARY_COLOR "D" MENU_PRIMARY_COLOR "ata Dump" MENU_VERTICAL_TAB "\x1" MENU_END_OF_OPTION
   MENU_SECONDARY_COLOR "A" MENU_PRIMARY_COLOR "vail Cfg"  MENU_END_OF_OPTION MENU_END_OF_TEXT;

char BMI_Comminucations_Menu_Text[] =

   MENU_SECONDARY_COLOR "S" MENU_PRIMARY_COLOR "end"     MENU_VERTICAL_TAB "\x1" MENU_END_OF_OPTION
...
char * BMI_Menu_Text_List[BMI_TOTAL_MENUS] = {

   BMI_Function_Key_Menu_Text,
   BMI_Main_Menu_Text,
   BMI_File_Menu_Text,
   BMI_Edit_Menu_Text,
   BMI_Report_Menu_Text,
   BMI_Comminucations_Menu_Text,
   BMI_Help_Menu_Text,
   BMI_Yes_No_Menu_Text

};

BMI_MENU_CHARACTERISTICS BMI_Menu_Characteristics_List[BMI_TOTAL_MENUS] = {
...
char * BMI_Menu_Keys_List[BMI_TOTAL_MENUS] = {
...
BMI_PROCESS_LIST BMI_Process_List[BMI_TOTAL_PROCESSES] = {

   {BMI_Display_Time},                     /* BMI_DISPLAY_TIME_PROCESS            */
...
char BMI_Main_Screen_Unique_Characters[] =

   "≤‹ﬂ€";

BYTE BMI_Main_Screen_Unique_Colors[] = {

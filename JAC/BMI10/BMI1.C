/* File        : BMI1.C
   Module      : MAIN
   System      : BMI
   Description : The main module for the BMI program.
...
/* Procedure   : BMI_Initialize_Parameters_List
...
void BMI_Initialize_Parameters_List(BMI_PARAMETERS_LIST * Parameters_List) {

   strcpy(Parameters_List->Default_Parameters.ID, BMI_CONFIG_FILE_TITLE);
   ...
   Parameters_List->Default_Parameters.Function_Key_Menu_Colors.Primary_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (LIGHTGRAY << 4) | BLACK : (LIGHTGRAY << 4) | BLACK;
   Parameters_List->Default_Parameters.Function_Key_Menu_Colors.Secondary_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (LIGHTGRAY << 4) | RED : (LIGHTGRAY << 4) | BLACK;
   Parameters_List->Default_Parameters.Function_Key_Menu_Colors.Primary_Highlight_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (BLUE << 4) | WHITE : (BLACK << 4) | LIGHTGRAY;
   Parameters_List->Default_Parameters.Function_Key_Menu_Colors.Secondary_Highlight_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (BLUE << 4) | WHITE : (BLACK << 4) | DARKGRAY;

   Parameters_List->Default_Parameters.Main_Menu_Colors.Primary_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (LIGHTGRAY << 4) | BLACK : (LIGHTGRAY << 4) | BLACK;
   Parameters_List->Default_Parameters.Main_Menu_Colors.Secondary_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (LIGHTGRAY << 4) | RED : (LIGHTGRAY << 4) | BLACK;
   Parameters_List->Default_Parameters.Main_Menu_Colors.Primary_Highlight_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (GREEN << 4) | BLACK : (BLACK << 4) | LIGHTGRAY;
   Parameters_List->Default_Parameters.Main_Menu_Colors.Secondary_Highlight_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (GREEN << 4) | RED : (BLACK << 4) | DARKGRAY;

   Parameters_List->Default_Parameters.Sub_Menu_Colors.Primary_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (LIGHTGRAY << 4) | BLACK : (LIGHTGRAY << 4) | BLACK;
   Parameters_List->Default_Parameters.Sub_Menu_Colors.Secondary_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (LIGHTGRAY << 4) | RED : (LIGHTGRAY << 4) | BLACK;
   Parameters_List->Default_Parameters.Sub_Menu_Colors.Primary_Highlight_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (GREEN << 4) | BLACK : (BLACK << 4) | LIGHTGRAY;
   Parameters_List->Default_Parameters.Sub_Menu_Colors.Secondary_Highlight_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (GREEN << 4) | RED : (BLACK << 4) | DARKGRAY;

   Parameters_List->Default_Parameters.Yes_No_Menu_Colors.Primary_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (LIGHTGRAY << 4) | BLACK : (LIGHTGRAY << 4) | BLACK;
   Parameters_List->Default_Parameters.Yes_No_Menu_Colors.Secondary_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (LIGHTGRAY << 4) | RED : (LIGHTGRAY << 4) | BLACK;
   Parameters_List->Default_Parameters.Yes_No_Menu_Colors.Primary_Highlight_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (GREEN << 4) | BLACK : (BLACK << 4) | LIGHTGRAY;
   Parameters_List->Default_Parameters.Yes_No_Menu_Colors.Secondary_Highlight_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (GREEN << 4) | RED : (BLACK << 4) | DARKGRAY;

   Parameters_List->Default_Parameters.Edit_Colors.Primary_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (LIGHTGRAY << 4) | BLACK : (LIGHTGRAY << 4) | BLACK;
   Parameters_List->Default_Parameters.Edit_Colors.Secondary_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (LIGHTGRAY << 4) | RED : (LIGHTGRAY << 4) | BLACK;
   Parameters_List->Default_Parameters.Edit_Colors.Primary_Highlight_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (GREEN << 4) | BLACK : (BLACK << 4) | LIGHTGRAY;
   Parameters_List->Default_Parameters.Edit_Colors.Secondary_Highlight_Color = (Parameters_List->Display_Type == BMI_COLOR) ? (GREEN << 4) | RED : (BLACK << 4) | DARKGRAY;
...
/* Procedure   : BMI_Display_Main_Screen_Text
...
void BMI_Display_Main_Screen_Text(char * Main_Screen_Text, char * Character_List, BYTE * Attribute_List, TEXT Text) {
...
/* Procedure   : BMI_Display_Main_Screen
...
void BMI_Display_Main_Screen(BMI_PARAMETERS_LIST * Parameters_List) {
   ...
   BMI_Display_Main_Screen_Text(Parameters_List->Main_Screen_Text, Parameters_List->Main_Screen_Characters, Parameters_List->Main_Screen_Character_Colors, Parameters_List->Text);
...
int BMI_Sub_Menu(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   BMI_SUB_MENU_PARAMETERS * parameters;
   BMI_MENU_TYPES            i;
   BMI_PROCESS_TYPES         absolute_process;
   ...
   if ((result = BMI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
      ...
      if (*(Process_Parameters) == NULL) {
         ...
         BMI_Set_Help_Screen(parameters->Parameters_List, BMI_Help_Index_Key_List[((BMI_MAIN_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[BMI_MAIN_MENU_PROCESS].Process_Parameters)->Option - 1 + BMI_HELP_FILEM]);
         ...
         if (!parameters->Refresh_Flag) {
            ...
            if (result == 0 && (result = PORT_Constructor(parameters->Starting_Row, parameters->Starting_Column, parameters->Height, parameters->Width, PORT_SINGLE_LINE_BORDER, parameters->Colors.Primary_Color, parameters->Colors.Primary_Color, &(parameters->Port))) == PORT_NOERR) {
         ...
         if (result == EZERO && *(Key) != 0) {
            ...
            if (valid_key_flag) {
               ...
               *(Key) = 0;
               result = MENU_Display(parameters->Menu, parameters->Option);
               parameters->Parameters_List->Menu_Characteristics_List[((BMI_MAIN_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[BMI_MAIN_MENU_PROCESS].Process_Parameters)->Option - 1 + BMI_FILE_MENU].Option = parameters->Option;
	    ...
	    if (process_aborted_flag || process_selected_flag) {
		  ...
		  BMI_Halt_Process(parameters->Parameters_List, BMI_SUB_MENU_PROCESS);
		  result = PORT_Destructor(&(parameters->Port));
		  ...
		  for (i = 1, absolute_process = parameters->Option; i < ((BMI_MAIN_MENU_PARAMETERS *) (parameters->Parameters_List->Process_Descriptor[BMI_MAIN_MENU_PROCESS].Process_Parameters))->Option; i++) {

                     absolute_process += strlen(BMI_Menu_Keys_List[BMI_FILE_MENU + i - 1]);

                  }

                  BMI_Activate_Process(parameters->Parameters_List, absolute_process);
...
int BMI_Main_Menu(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   BMI_MAIN_MENU_PARAMETERS * parameters;
   CARDINAL_16                position;
   ...
   if ((result = BMI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
      ...
      if (*(Process_Parameters) == NULL) {
         ...
         if (!parameters->Parameters_List->Process_Descriptor[BMI_SUB_MENU_PROCESS].Process_Active_Flag && !parameters->Parameters_List->Process_Descriptor[BMI_YES_NO_MENU_PROCESS].Process_Active_Flag) {

            BMI_Set_Help_Screen(parameters->Parameters_List, BMI_Help_Index_Key_List[BMI_HELP_MAINM]);
         ...
         if (result == EZERO && *(Key) != 0) {
            ...
            switch (*(Key)) {
               ...
               case KB_SHIFT_TAB :
                  ...
                  if (parameters->Parameters_List->Process_Descriptor[BMI_SUB_MENU_PROCESS].Process_Active_Flag) {
            ...
            if (valid_key_flag) {
               ...
               *(Key) = 0;
               ...
               if (option_selected_flag) {
                  ...
                  BMI_Activate_Process(parameters->Parameters_List, BMI_SUB_MENU_PROCESS);
                  ((BMI_SUB_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[BMI_SUB_MENU_PROCESS].Process_Parameters)->Menu_Text = parameters->Parameters_List->Menu_Text_List[parameters->Option - 1 + BMI_FILE_MENU];
                  ((BMI_SUB_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[BMI_SUB_MENU_PROCESS].Process_Parameters)->Menu_Keys_List = parameters->Parameters_List->Menu_Keys_List[parameters->Option - 1 + BMI_FILE_MENU];
                  ((BMI_SUB_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[BMI_SUB_MENU_PROCESS].Process_Parameters)->Starting_Row = parameters->Parameters_List->Menu_Characteristics_List[parameters->Option - 1 + BMI_FILE_MENU].Starting_Row;
                  ((BMI_SUB_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[BMI_SUB_MENU_PROCESS].Process_Parameters)->Starting_Column = parameters->Parameters_List->Menu_Characteristics_List[parameters->Option - 1 + BMI_FILE_MENU].Starting_Column;
                  ((BMI_SUB_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[BMI_SUB_MENU_PROCESS].Process_Parameters)->Height = parameters->Parameters_List->Menu_Characteristics_List[parameters->Option - 1 + BMI_FILE_MENU].Height;
                  ((BMI_SUB_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[BMI_SUB_MENU_PROCESS].Process_Parameters)->Width = parameters->Parameters_List->Menu_Characteristics_List[parameters->Option - 1 + BMI_FILE_MENU].Width;
                  ((BMI_SUB_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[BMI_SUB_MENU_PROCESS].Process_Parameters)->Option = parameters->Parameters_List->Menu_Characteristics_List[parameters->Option - 1 + BMI_FILE_MENU].Option;
                  ((BMI_SUB_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[BMI_SUB_MENU_PROCESS].Process_Parameters)->Total_Options = parameters->Parameters_List->Menu_Characteristics_List[parameters->Option - 1 + BMI_FILE_MENU].Total_Options;
                  ((BMI_SUB_MENU_PARAMETERS *) parameters->Parameters_List->Process_Descriptor[BMI_SUB_MENU_PROCESS].Process_Parameters)->Refresh_Flag = TRUE;
...
/* Function    : BMI_Function_Key_Menu
...
int BMI_Function_Key_Menu(void ** Process_Parameters, CARDINAL_16 * Key) {
   ...
   BMI_FUNCTION_KEY_MENU_PARAMETERS * parameters;
   ...
   if ((result = BMI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
      ...
      if (*(Process_Parameters) == NULL) {
         ...
         if (parameters->Parameters_List->Process_Descriptor[BMI_EDIT_EDIT_PROCESS].Process_Active_Flag || parameters->Parameters_List->Process_Descriptor[BMI_HELP_TOPIC_PROCESS].Process_Active_Flag && !parameters->Hide_Function_Keys_Flag) {

            window(1, 1, 80, 25);
            TEXT_Set_Text_Color(parameters->Colors.Primary_Color, parameters->Text);

            if (parameters->Parameters_List->Process_Descriptor[BMI_EDIT_EDIT_PROCESS].Process_Active_Flag) {
            ...
            if (parameters->Parameters_List->Process_Descriptor[BMI_HELP_TOPIC_PROCESS].Process_Active_Flag) {
            ...
            if (!parameters->Parameters_List->Process_Descriptor[BMI_EDIT_EDIT_PROCESS].Process_Active_Flag && !parameters->Parameters_List->Process_Descriptor[BMI_COMMUNICATIONS_TERMINAL_PROCESS].Process_Active_Flag && !parameters->Parameters_List->Process_Descriptor[BMI_HELP_TOPIC_PROCESS].Process_Active_Flag && parameters->Hide_Function_Keys_Flag) {
         ...
         if (result == EZERO && *(Key) != 0) {
            ...
            switch (*(Key)) {
               ...
               case KB_F2 :
                  ...
                  for (invoke_process_flag = TRUE, i = BMI_FILE_LOAD_PROCESS; i <= BMI_SUB_MENU_PROCESS; i++) {
                  ...
                  if (invoke_process_flag) {
                     ...
                     BMI_Activate_Process(parameters->Parameters_List, BMI_FILE_LOAD_PROCESS);
                     BMI_Halt_Process(parameters->Parameters_List, BMI_MAIN_MENU_PROCESS);
               ...
               case KB_F3 :
                  ...
                  for (invoke_process_flag = TRUE, i = BMI_FILE_LOAD_PROCESS; i <= BMI_SUB_MENU_PROCESS; i++) {
                     ...
                     if (i != BMI_EDIT_EDIT_PROCESS && parameters->Parameters_List->Process_Descriptor[i].Process_Active_Flag) {
               ...
               case KB_F8 :
                  ...
                  if (invoke_process_flag) {
                     ...
                     BMI_Activate_Process(parameters->Parameters_List, BMI_COMMUNICATIONS_TERMINAL_PROCESS);
                     BMI_Halt_Process(parameters->Parameters_List, BMI_MAIN_MENU_PROCESS);
               ...
               case KB_F9 :
                  ...
                  if (invoke_process_flag) {
                     ...
                     BMI_Activate_Process(parameters->Parameters_List, BMI_COMMUNICATIONS_SEND_PROCESS);
                     BMI_Halt_Process(parameters->Parameters_List, BMI_MAIN_MENU_PROCESS);
               ...
               case KB_F10 :
                  ...
                  if (invoke_process_flag) {
                     ...
                     BMI_Activate_Process(parameters->Parameters_List, BMI_COMMUNICATIONS_RECEIVE_PROCESS);
                     BMI_Halt_Process(parameters->Parameters_List, BMI_MAIN_MENU_PROCESS);
               ...
               case KB_ESC :
                  ...
                  BMI_Activate_Process(parameters->Parameters_List, BMI_FILE_QUIT_PROCESS);
                  break;
...
/* Function    : BMI_Initialize
   Description : Initializes the BMI system.
   Inputs      : Nothing.
   Updates     : Nothing.
   Outputs     : Parameters_List = The parameters list to use while the BMI system is active.
   Returns     : The value of the last error that occurred.  A value of zero indicates that no errors occurred.
   Modified    : 08/18/92 DWP Initial coding.
   Notes       :
*/

int BMI_Initialize(BMI_PARAMETERS_LIST * Parameters_List) {

   BMI_PROCESS_DESCRIPTOR *             process_descriptor;
   BMI_PROCESS_TYPES                    process_number;
   BMI_DISPLAY_TIME_PARAMETERS *        display_time_parameters;
   BMI_FILE_LOAD_PARAMETERS *           file_load_parameters;
   BMI_FILE_NEW_PARAMETERS *            file_new_parameters;
   BMI_FILE_SAVE_PARAMETERS *           file_save_parameters;
   BMI_FILE_SAVE_AS_PARAMETERS *            file_save_as_parameters;
   BMI_FILE_DELETE_PARAMETERS *             file_delete_parameters;
   BMI_FILE_RENAME_PARAMETERS *             file_rename_parameters;
   BMI_FILE_QUIT_PARAMETERS *               file_quit_parameters;
   BMI_EDIT_EDIT_PARAMETERS *               edit_edit_parameters;
   BMI_EDIT_MARK_PARAMETERS *               edit_mark_parameters;
   BMI_EDIT_CLEAR_PARAMETERS *              edit_clear_parameters;
   BMI_REPORTS_DATA_DUMP_PARAMETERS *       reports_data_dump_parameters;
   BMI_REPORTS_AVAIL_CFG_PARAMETERS *       reports_available_configurations_parameters;
   BMI_COMMUNICATIONS_SEND_PARAMETERS *     comm_send_parameters;
   BMI_COMMUNICATIONS_RECEIVE_PARAMETERS *  comm_receive_parameters;
   BMI_COMMUNICATIONS_TERMINAL_PARAMETERS * comm_terminal_parameters;
   BMI_HELP_INDEX_PARAMETERS *              help_index_parameters;
   BMI_HELP_ABOUT_PARAMETERS *              help_about_parameters;
   BMI_HELP_PRINT_PARAMETERS *              help_print_parameters;
   BMI_HELP_TOPIC_PARAMETERS *              help_topic_parameters;
   BMI_YES_NO_MENU_PARAMETERS *             yes_no_menu_parameters;
   BMI_SUB_MENU_PARAMETERS *                sub_menu_parameters;
   BMI_MAIN_MENU_PARAMETERS *               main_menu_parameters;
   BMI_FUNCTION_KEY_MENU_PARAMETERS *       function_key_menu_parameters;
   CARDINAL_16                              i, key = 0;
   int                                      result = EZERO;

   if (BMI_Load_Configuration(BMI_CONFIG_FILE_NAME, &(Parameters_List->Default_Parameters)) != EZERO || (Parameters_List->Display_Type != Parameters_List->Default_Parameters.Display_Type) || (Parameters_List->Port_No != Parameters_List->Default_Parameters.Port_No)) {

      BMI_Initialize_Parameters_List(Parameters_List);
      result = BMI_Save_Configuration(BMI_CONFIG_FILE_NAME, &(Parameters_List->Default_Parameters));

   }

   textmode((Parameters_List->Display_Type == BMI_COLOR) ? C80 : BW80);
   ...
   memcpy(&(Parameters_List->Menu_Characteristics_List), BMI_Menu_Characteristics_List, sizeof(Parameters_List->Menu_Characteristics_List));
   memcpy(Parameters_List->Menu_Text_List, BMI_Menu_Text_List, sizeof(Parameters_List->Menu_Text_List));
   memcpy(Parameters_List->Menu_Keys_List, BMI_Menu_Keys_List, sizeof(Parameters_List->Menu_Keys_List));
   Parameters_List->Main_Screen_Text = BMI_Main_Screen_Text;
   Parameters_List->Main_Screen_Characters = BMI_Main_Screen_Unique_Characters;
   Parameters_List->Main_Screen_Character_Colors = BMI_Main_Screen_Unique_Colors;

   Parameters_List->Total_Processes = BMI_TOTAL_PROCESSES;
   ...
   for (process_number = 0; process_number < Parameters_List->Total_Processes; process_number++) {
      ...
      BMI_Halt_Process(Parameters_List, process_number);
      process_descriptor->Process_Parameters = NULL;
      process_descriptor->Process = BMI_Process_List[process_number].Process;
         ...
         if (result == EZERO) {
            ...
            switch (process_number) {
               ...
               case BMI_DISPLAY_TIME_PROCESS :
                  ...
                  BMI_Activate_Process(Parameters_List, BMI_DISPLAY_TIME_PROCESS);
                  break;

               case BMI_FILE_LOAD_PROCESS :
               ...
               case BMI_FILE_SAVE_PROCESS :
                  ...
                  file_save_parameters->File_Name.Length = 8;
               ...
               case BMI_FILE_RENAME_PROCESS :
                  ...
                  file_rename_parameters->New_File_Name.Length = 8;
               ...
               case BMI_EDIT_EDIT_PROCESS :
                  ...
                  edit_edit_parameters->Part_Number.Length = 16;
                  ...
                  edit_edit_parameters->Valve_Pack_Number.Length = 4;
                  ...
                  edit_edit_parameters->Valve_Pack_Number.Maximum_Value = 4095;

                  edit_edit_parameters->Multiple_Part_Number.Text = Parameters_List->Text;
                  edit_edit_parameters->Multiple_Part_Number.Length = 1;
                  ...
                  edit_edit_parameters->Multiple_Part_Number.Maximum_Value = 4;

                  edit_edit_parameters->Last_Bin_Sensor.Text = Parameters_List->Text;
                  edit_edit_parameters->Last_Bin_Sensor.Length = 4;
                  ...
                  edit_edit_parameters->Last_Bin_Sensor.Maximum_Value = 3275;

                  edit_edit_parameters->Total_Cycle_Time.Text = Parameters_List->Text;
                  edit_edit_parameters->Total_Cycle_Time.Length = 4;
                  ...
                  edit_edit_parameters->Total_Cycle_Time.Maximum_Value = 3276;

                  for (i = 0; i < 80; i++) {

                     edit_edit_parameters->Advance_Time[i].Text = Parameters_List->Text;
                     edit_edit_parameters->Advance_Time[i].Length = 4;
                     ...
                     edit_edit_parameters->Advance_Time[i].Maximum_Value = 3275;

                     edit_edit_parameters->Retract_Time[i].Text = Parameters_List->Text;
                     edit_edit_parameters->Retract_Time[i].Length = 4;
                     ...
                     edit_edit_parameters->Retract_Time[i].Maximum_Value = 3276;

                  }

                  BMI_Clear_Edit_Parameters(edit_edit_parameters);
                  edit_edit_parameters->Top_Row_Starting_Number = 1;
                  break;

               case BMI_EDIT_MARK_PROCESS :
               ...
               case BMI_REPORTS_DATA_DUMP_PROCESS :
               ...
               case BMI_REPORTS_AVAIL_CFG_PROCESS :
               ...
               case BMI_COMMUNICATIONS_SEND_PROCESS :
                  ...
                  comm_send_parameters->Unit_Number.Length = 1;
                  ...
                  comm_send_parameters->Save_Timing_Values.Length = 1;
               ...
               case BMI_COMMUNICATIONS_RECEIVE_PROCESS :
               ...
               case BMI_COMMUNICATIONS_TERMINAL_PROCESS :
               ...
               case BMI_HELP_INDEX_PROCESS :
                  ...
                  BMI_Activate_Process(Parameters_List, BMI_HELP_INDEX_PROCESS);
                  break;

               case BMI_HELP_ABOUT_PROCESS :
                  ...
                  help_about_parameters->Width = 54;
                  BMI_Activate_Process(Parameters_List, BMI_HELP_ABOUT_PROCESS);
                  break;

               case BMI_HELP_PRINT_PROCESS :
               ...
               case BMI_YES_NO_MENU_PROCESS :
                  ...
                  yes_no_menu_parameters->Menu_Text = Parameters_List->Menu_Text_List[BMI_YES_NO_MENU];
                  yes_no_menu_parameters->Menu_Keys_List = Parameters_List->Menu_Keys_List[BMI_YES_NO_MENU];
                  yes_no_menu_parameters->Option = 1;

                  break;

               case BMI_SUB_MENU_PROCESS :
               ...
               case BMI_MAIN_MENU_PROCESS :
                  ...
                  main_menu_parameters->Menu_Text = Parameters_List->Menu_Text_List[BMI_MAIN_MENU];
                  main_menu_parameters->Menu_Keys_List = Parameters_List->Menu_Keys_List[BMI_MAIN_MENU];
                  main_menu_parameters->Starting_Row = Parameters_List->Menu_Characteristics_List[BMI_MAIN_MENU].Starting_Row;
                  main_menu_parameters->Starting_Column = Parameters_List->Menu_Characteristics_List[BMI_MAIN_MENU].Starting_Column;
                  main_menu_parameters->Option = Parameters_List->Menu_Characteristics_List[BMI_MAIN_MENU].Option;
                  main_menu_parameters->Total_Options = Parameters_List->Menu_Characteristics_List[BMI_MAIN_MENU].Total_Options;
                  main_menu_parameters->Exit_Flag = FALSE;
                  BMI_Activate_Process(Parameters_List, BMI_MAIN_MENU_PROCESS);
                  break;

               case BMI_FUNCTION_KEY_MENU_PROCESS :
                  ...
                  function_key_menu_parameters->Menu_Text = Parameters_List->Menu_Text_List[BMI_FUNCTION_KEY_MENU];
                  ...
                  function_key_menu_parameters->Starting_Row = Parameters_List->Menu_Characteristics_List[BMI_FUNCTION_KEY_MENU].Starting_Row;
                  function_key_menu_parameters->Starting_Column = Parameters_List->Menu_Characteristics_List[BMI_FUNCTION_KEY_MENU].Starting_Column;
                  function_key_menu_parameters->Hide_Function_Keys_Flag = FALSE;
                  BMI_Activate_Process(Parameters_List, BMI_FUNCTION_KEY_MENU_PROCESS);
                  break;
...
/* Function    : BMI_Main
   Description : The main entry point for the MAIN module of the BMI program.
   Inputs      : Nothing.
   Updates     : Nothing.
   Outputs     : Parameters_List = The parameters list to use while the BMI system is active.
   Returns     : The value of the last error that occurred.  A value of zero indicates that no errors occurred.
...
int BMI_Main(BMI_PARAMETERS_LIST * Parameters_List) {
   ...
   if ((result = BMI_Initialize(Parameters_List)) == EZERO) {
      ...
      if ((result = PORT_Constructor(1, 1, 25, 80, PORT_NO_BORDER, LIGHTGRAY, LIGHTGRAY, &main_screen)) == PORT_NOERR) {
         ...
         CURSOR_Off();
         BMI_Display_Main_Screen(Parameters_List);
         ...
         for (exit_flag = FALSE; !exit_flag && result == 0;) {
            ...
            for (process_number = 0; result == EZERO && process_number < Parameters_List->Total_Processes; process_number++) {
               ...
               if (Parameters_List->Process_Descriptor[process_number].Process_Active_Flag) {
                  ...
                  if (!Parameters_List->Process_Descriptor[BMI_HELP_TOPIC_PROCESS].Process_Active_Flag || process_number == BMI_DISPLAY_TIME_PROCESS || process_number == BMI_HELP_TOPIC_PROCESS || process_number == BMI_FUNCTION_KEY_MENU_PROCESS) {
...
/* Function    : main
   Description : The main entry point for the BMI program.
...
int main(int argc, char * argv[]) {
   ...
   if (_osmajor < 3 || (_osmajor == 3 && _osminor < 3)) {
      ...
      printf("\nBMI Requires MS-DOS Version 3.3 Or Higher\n");
      ...
      if (findfirst("BMI.CFG", &ffblk, FA_ARCH) != 0) {

         setmem(&(parameters_list.Default_Parameters), sizeof(parameters_list.Default_Parameters), 0);
         gettextinfo(&text_info);
         parameters_list.Display_Type = (text_info.currmode == 3) ? BMI_COLOR : BMI_MONOCHROME;
      ...
      for (i = 1; i < argc; i++) {
         ...
         if (strchr("-/", argv[i][0]) != NULL) {
            ...
            if (stricmp("COLOR", &(argv[i][1])) == 0) {
               ...
               parameters_list.Display_Type = BMI_COLOR;
            ...
            if (stricmp("MONO", &(argv[i][1])) == 0) {
               ...
               parameters_list.Display_Type = BMI_MONOCHROME;
               parameters_list.Display_Type_Specified = TRUE;
            ...
            if (stricmp("LCD", &(argv[i][1])) == 0) {
               ...
               parameters_list.Display_Type = BMI_LCD;
               parameters_list.Display_Type_Specified = TRUE;

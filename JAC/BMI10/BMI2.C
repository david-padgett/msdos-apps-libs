...
void BMI_Edit_Update_Process_Parameters(BOOLEAN Update_Top_Row_Starting_Number_Flag, int Top_Row_Starting_Number_Increment_Value, BMI_EDIT_EDIT_PARAMETERS * Process_Parameters) {
   ...
   if (Process_Parameters->Current_Field_Descriptor->Type == INTEGER_16_TYPE) {
      ...
      if (Process_Parameters->Current_Field_Descriptor->Maximum_Value < atoi(Process_Parameters->Current_Field_Descriptor->Value) || Process_Parameters->Current_Field_Descriptor->Minimum_Value > atoi(Process_Parameters->Current_Field_Descriptor->Value)) {

         sprintf(str, "%*d", Process_Parameters->Current_Field_Descriptor->Length, Process_Parameters->Current_Field_Descriptor->Integer_Value);
         strncpy(Process_Parameters->Current_Field_Descriptor->Value, str, 4);
...
void BMI_Edit_Special_Processing(BMI_EDIT_EDIT_PARAMETERS * Process_Parameters, BOOLEAN * Update_Top_Row_Starting_Number_Flag, BOOLEAN * Timing_Values_Altered_Flag) {
   ...
   if (Process_Parameters->Field >= BMI_TOTAL_UNIQUE_EDIT_FIELDS) {
      ...
      if (previous_value + displacement_value >= Process_Parameters->Current_Field_Descriptor->Minimum_Value && previous_value + displacement_value <= Process_Parameters->Current_Field_Descriptor->Maximum_Value) {
         ...
         if (Process_Parameters->Current_Field_Descriptor->Value[0] == '+' || Process_Parameters->Current_Field_Descriptor->Value[0] == '-') {
            ...
            if (previous_value == 0) {
               ...
               Process_Parameters->Current_Field_Descriptor->Integer_Value = atoi(Process_Parameters->Current_Field_Descriptor->Value);
               sprintf(Process_Parameters->Current_Field_Descriptor->Value, "%*d", Process_Parameters->Current_Field_Descriptor->Length, Process_Parameters->Current_Field_Descriptor->Integer_Value);
               ...
               *(Timing_Values_Altered_Flag) = TRUE;
               ...
               for (i = (Process_Parameters->Field - BMI_TOTAL_UNIQUE_EDIT_FIELDS) / 2; i < (BMI_TOTAL_EDIT_FIELDS - BMI_TOTAL_UNIQUE_EDIT_FIELDS + 1) / 2; i++) {
                  ...
                  if (Process_Parameters->Advance_Time[i].Integer_Value != 0 && Process_Parameters->Advance_Time[i].Integer_Value >= previous_value) {
                     ...
                     sprintf(Process_Parameters->Advance_Time[i].Value, "%*d", Process_Parameters->Advance_Time[i].Length, Process_Parameters->Advance_Time[i].Integer_Value);
                  ...
                  if (Process_Parameters->Retract_Time[i].Integer_Value != 0 && Process_Parameters->Retract_Time[i].Integer_Value >= previous_value) {
                     ...
                     sprintf(Process_Parameters->Retract_Time[i].Value, "%*d", Process_Parameters->Retract_Time[i].Length, Process_Parameters->Retract_Time[i].Integer_Value);
         ...
         *(Update_Top_Row_Starting_Number_Flag) = TRUE;
         ...
         if (atoi(Process_Parameters->Advance_Time[(Process_Parameters->Field - BMI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Value) != 0 && atoi(Process_Parameters->Advance_Time[(Process_Parameters->Field - BMI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Value) >= atoi(Process_Parameters->Retract_Time[(Process_Parameters->Field - BMI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Value)) {
            ...
            sprintf(Process_Parameters->Retract_Time[(Process_Parameters->Field - BMI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Value, "%*d", Process_Parameters->Retract_Time[(Process_Parameters->Field - BMI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Length, Process_Parameters->Retract_Time[(Process_Parameters->Field - BMI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Integer_Value);
            ...
            if (Process_Parameters->Retract_Time[(Process_Parameters->Field - BMI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Integer_Value > Process_Parameters->Total_Cycle_Time.Integer_Value) {
               ...
               sprintf(Process_Parameters->Total_Cycle_Time.Value, "%*d", Process_Parameters->Total_Cycle_Time.Length, Process_Parameters->Retract_Time[(Process_Parameters->Field - BMI_TOTAL_UNIQUE_EDIT_FIELDS) / 2].Integer_Value);
         ...
         if (Process_Parameters->Field % 2 == 1 && atoi(Process_Parameters->Current_Field_Descriptor->Value) > atoi(Process_Parameters->Total_Cycle_Time.Value) && atoi(Process_Parameters->Current_Field_Descriptor->Value) <= Process_Parameters->Total_Cycle_Time.Maximum_Value && atoi(Process_Parameters->Current_Field_Descriptor->Value) >= Process_Parameters->Total_Cycle_Time.Minimum_Value) {

            sprintf(Process_Parameters->Total_Cycle_Time.Value, "%*.*s", Process_Parameters->Total_Cycle_Time.Length, Process_Parameters->Total_Cycle_Time.Length, Process_Parameters->Current_Field_Descriptor->Value);
         ...
         if (Process_Parameters->Field % 2 == 0 && atoi(Process_Parameters->Current_Field_Descriptor->Value) > atoi(Process_Parameters->Last_Bin_Sensor.Value) && atoi(Process_Parameters->Current_Field_Descriptor->Value) <= Process_Parameters->Last_Bin_Sensor.Maximum_Value && atoi(Process_Parameters->Current_Field_Descriptor->Value) >= Process_Parameters->Last_Bin_Sensor.Minimum_Value) {

            sprintf(Process_Parameters->Last_Bin_Sensor.Value, "%*.*s", Process_Parameters->Last_Bin_Sensor.Length, Process_Parameters->Last_Bin_Sensor.Length, Process_Parameters->Current_Field_Descriptor->Value);
   ...
   if ((result = BMI_Validate_Parameters(Process_Parameters, Key)) == EZERO) {
      ...
      if (*(Process_Parameters) == NULL) {
         ...
         if (result == EZERO) {
            ...
            if (parameters->Field == 2 && parameters->Valve_Pack_Number.Integer_Value != 0) {
         ...
         if (parameters->Process_In_Progress_Flag) {
            ...
            if ((int) parameters->Print_Report_Flag != -1) {
               ...
               if (!parameters->Print_Report_Flag) {
                     ...
                     *(Key) = 0;
                     ...
                     if (PRINTER_Status(0) != (PRINTER_NOT_BUSY | PRINTER_SELECTED)) {
                        ...
                        if ((report_file = fopen("PRN", "wt")) != NULL) {
                           ...
                           fprintf(report_file, "Valve Pack Number        : %4u\n", parameters->Edit_Parameters->Valve_Pack_Number.Integer_Value);
                           fprintf(report_file, "Multiple Sequence Number : %4u\n", parameters->Edit_Parameters->Multiple_Part_Number.Integer_Value);
                           fprintf(report_file, "Last Bin Sensor          : %4u\n", parameters->Edit_Parameters->Last_Bin_Sensor.Integer_Value);
                           fprintf(report_file, "Total Cycle Time         : %4u\n", parameters->Edit_Parameters->Total_Cycle_Time.Integer_Value);
			      ...
			      fprintf(report_file, "   %4u   %4u  ", parameters->Edit_Parameters->Advance_Time[i].Integer_Value, parameters->Edit_Parameters->Retract_Time[i].Integer_Value);
...
void BMI_Send_Construct_Send_String(BMI_COMMUNICATIONS_SEND_PARAMETERS * Process_Parameters) {
   ...
   switch (Process_Parameters->Parameter_Number) {
      ...
      case 2 :
         ...
         sprintf(Process_Parameters->Send_String, "PN%-*.*s", Process_Parameters->Edit_Parameters->Part_Number.Length, Process_Parameters->Edit_Parameters->Part_Number.Length, Process_Parameters->Edit_Parameters->Part_Number.Value);
         break;

      case 3 :

         if (Process_Parameters->Edit_Parameters->Valve_Pack_Number.Integer_Value < Process_Parameters->Edit_Parameters->Valve_Pack_Number.Minimum_Value || Process_Parameters->Edit_Parameters->Valve_Pack_Number.Integer_Value > Process_Parameters->Edit_Parameters->Valve_Pack_Number.Maximum_Value) {
            ...
            sprintf(Process_Parameters->Edit_Parameters->Valve_Pack_Number.Value, "%*d", Process_Parameters->Edit_Parameters->Valve_Pack_Number.Length, Process_Parameters->Edit_Parameters->Valve_Pack_Number.Integer_Value);

         }

         sprintf(Process_Parameters->Send_String, "CD%0*u", Process_Parameters->Edit_Parameters->Valve_Pack_Number.Length, Process_Parameters->Edit_Parameters->Valve_Pack_Number.Integer_Value);
         break;

      case 4 :

         if (Process_Parameters->Edit_Parameters->Multiple_Part_Number.Integer_Value < Process_Parameters->Edit_Parameters->Multiple_Part_Number.Minimum_Value || Process_Parameters->Edit_Parameters->Multiple_Part_Number.Integer_Value > Process_Parameters->Edit_Parameters->Multiple_Part_Number.Maximum_Value) {
            ...
            sprintf(Process_Parameters->Edit_Parameters->Multiple_Part_Number.Value, "%*d", Process_Parameters->Edit_Parameters->Multiple_Part_Number.Length, Process_Parameters->Edit_Parameters->Multiple_Part_Number.Integer_Value);

         }

         sprintf(Process_Parameters->Send_String, "MP%0*u", Process_Parameters->Edit_Parameters->Multiple_Part_Number.Length, Process_Parameters->Edit_Parameters->Multiple_Part_Number.Integer_Value - 1);
         break;

      case 5 :

         if (Process_Parameters->Edit_Parameters->Last_Bin_Sensor.Integer_Value < Process_Parameters->Edit_Parameters->Last_Bin_Sensor.Minimum_Value || Process_Parameters->Edit_Parameters->Last_Bin_Sensor.Integer_Value > Process_Parameters->Edit_Parameters->Last_Bin_Sensor.Maximum_Value) {
            ...
            sprintf(Process_Parameters->Edit_Parameters->Last_Bin_Sensor.Value, "%*d", Process_Parameters->Edit_Parameters->Last_Bin_Sensor.Length, Process_Parameters->Edit_Parameters->Last_Bin_Sensor.Integer_Value);

         }

         sprintf(Process_Parameters->Send_String, "LB%0*u", Process_Parameters->Edit_Parameters->Last_Bin_Sensor.Length, Process_Parameters->Edit_Parameters->Last_Bin_Sensor.Integer_Value);
         break;

      case 6 :

         if (Process_Parameters->Edit_Parameters->Total_Cycle_Time.Integer_Value < Process_Parameters->Edit_Parameters->Total_Cycle_Time.Minimum_Value || Process_Parameters->Edit_Parameters->Total_Cycle_Time.Integer_Value > Process_Parameters->Edit_Parameters->Total_Cycle_Time.Maximum_Value) {
            ...
            sprintf(Process_Parameters->Edit_Parameters->Total_Cycle_Time.Value, "%*d", Process_Parameters->Edit_Parameters->Total_Cycle_Time.Length, Process_Parameters->Edit_Parameters->Total_Cycle_Time.Integer_Value);

         }

         sprintf(Process_Parameters->Send_String, "TC%0*u", Process_Parameters->Edit_Parameters->Total_Cycle_Time.Length, Process_Parameters->Edit_Parameters->Total_Cycle_Time.Integer_Value);
         break;
               ...
               if (i < Process_Parameters->Valve_Packs * 20) {
                  ...
                  if (Process_Parameters->Parameter_Number % 2 != 0) {
                     ...
                     if (!Process_Parameters->Edit_Parameters->Advance_Time[i].Marked_Flag) {
                        ...
                        if (Process_Parameters->Edit_Parameters->Advance_Time[i].Integer_Value < Process_Parameters->Edit_Parameters->Advance_Time[i].Minimum_Value || Process_Parameters->Edit_Parameters->Advance_Time[i].Integer_Value > Process_Parameters->Edit_Parameters->Advance_Time[i].Maximum_Value) {
                           ...
                           sprintf(Process_Parameters->Edit_Parameters->Advance_Time[i].Value, "%*d", Process_Parameters->Edit_Parameters->Advance_Time[i].Length, Process_Parameters->Edit_Parameters->Advance_Time[i].Integer_Value);

                        }

                        sprintf(Process_Parameters->Send_String, "VA%02u%0*u", i + 1, Process_Parameters->Edit_Parameters->Advance_Time[i].Length, Process_Parameters->Edit_Parameters->Advance_Time[i].Integer_Value);
                     ...
                     if (!Process_Parameters->Edit_Parameters->Retract_Time[i].Marked_Flag) {
                        ...
                        if (Process_Parameters->Edit_Parameters->Retract_Time[i].Integer_Value < Process_Parameters->Edit_Parameters->Retract_Time[i].Minimum_Value || Process_Parameters->Edit_Parameters->Retract_Time[i].Integer_Value > Process_Parameters->Edit_Parameters->Retract_Time[i].Maximum_Value) {
                           ...
                           sprintf(Process_Parameters->Edit_Parameters->Retract_Time[i].Value, "%*d", Process_Parameters->Edit_Parameters->Retract_Time[i].Length, Process_Parameters->Edit_Parameters->Retract_Time[i].Integer_Value);

                        }

                        sprintf(Process_Parameters->Send_String, "VR%02u%0*u", i + 1, Process_Parameters->Edit_Parameters->Retract_Time[i].Length, Process_Parameters->Edit_Parameters->Retract_Time[i].Integer_Value);
...
int BMI_Receive_Decode_String(BMI_COMMUNICATIONS_RECEIVE_PARAMETERS * Process_Parameters) {
   ...
   switch (Process_Parameters->Receive_String[0] * 2 + Process_Parameters->Receive_String[1]) {
      ...
      case 238 :
         ...
         strncpy(Process_Parameters->Edit_Parameters->Part_Number.Value, Process_Parameters->Receive_String + 2, Process_Parameters->Edit_Parameters->Part_Number.Length);
         break;
      ...
      case 202 :
         ...
         sprintf(Process_Parameters->Edit_Parameters->Valve_Pack_Number.Value, "%*u", Process_Parameters->Edit_Parameters->Valve_Pack_Number.Length, Process_Parameters->Edit_Parameters->Valve_Pack_Number.Integer_Value);
         break;
      ...
      case 234 :
         ...
         sprintf(Process_Parameters->Edit_Parameters->Multiple_Part_Number.Value, "%*u", Process_Parameters->Edit_Parameters->Multiple_Part_Number.Length, Process_Parameters->Edit_Parameters->Multiple_Part_Number.Integer_Value);
         break;
      ...
      case 218 :
         ...
         sprintf(Process_Parameters->Edit_Parameters->Last_Bin_Sensor.Value, "%*u", Process_Parameters->Edit_Parameters->Last_Bin_Sensor.Length, Process_Parameters->Edit_Parameters->Last_Bin_Sensor.Integer_Value);
         break;
      ...
      case 235 :
         ...
         sprintf(Process_Parameters->Edit_Parameters->Total_Cycle_Time.Value, "%*u", Process_Parameters->Edit_Parameters->Total_Cycle_Time.Length, Process_Parameters->Edit_Parameters->Total_Cycle_Time.Integer_Value);
         break;
      ...
      case 237 :
         ...
         if (i >= 0 && i < 80) {
            ...
            sprintf(Process_Parameters->Edit_Parameters->Advance_Time[i].Value, "%*u", Process_Parameters->Edit_Parameters->Advance_Time[i].Length, Process_Parameters->Edit_Parameters->Advance_Time[i].Integer_Value);
      ...
      case 254 :
         ...
         if (i >= 0 && i < 80) {
            ...
            sprintf(Process_Parameters->Edit_Parameters->Retract_Time[i].Value, "%*u", Process_Parameters->Edit_Parameters->Retract_Time[i].Length, Process_Parameters->Edit_Parameters->Retract_Time[i].Integer_Value);
      ...
      if (*(Process_Parameters) == NULL) {
         ...
         if (parameters->Port == NULL) {
            ...
            if (parameters->First_Pass_Flag) {
               ...
               sprintf(str, "RQ%0*u%*u\r\n", parameters->Edit_Parameters->Valve_Pack_Number.Length, parameters->Edit_Parameters->Valve_Pack_Number.Integer_Value, parameters->Edit_Parameters->Multiple_Part_Number.Length, parameters->Edit_Parameters->Multiple_Part_Number.Integer_Value);
               wrtbk_a1(parameters->Port_No, sizeof(str), '\0', str, &(pwritten));
               strcpy(str, "DN\r\n");
               wrtbk_a1(parameters->Port_No, sizeof(str), '\0', str, &(pwritten));
      ...
      if (*(Process_Parameters) == NULL) {
         ...
         if (parameters->Port != NULL) {
            ...
            if ((result = PORT_Constructor(parameters->Starting_Row, parameters->Starting_Column, parameters->Height, parameters->Width, PORT_SINGLE_LINE_BORDER, parameters->Colors.Primary_Color, parameters->Colors.Primary_Color, &(parameters->Port))) == PORT_NOERR) {
               ...
               TEXT_Set_Cursor_Position(2, (parameters->Width - strlen(BMI_TITLE_1)) / 2, parameters->Text);
               TEXT_Print_String(BMI_TITLE_1, parameters->Text);
                     ...
                     *(Key) = 0;
                     ...
                     if (parameters->Report_File == NULL) {
                        ...
                        if (parameters->New_Page_Flag) {
                           ...
                           fprintf(parameters->Report_File, "\n%*s%s\n\n", (80 - sizeof(BMI_TITLE_1)) / 2, "", BMI_TITLE_1);
